...
![alt text](benchmark_results/image-1.png)
...
![alt text](benchmark_results/kien_truc_tong_quan.png)
...
![alt text](benchmark_results/data_flow.png)
...
![alt text](benchmark_results/image.png)
...
![alt text](benchmark_results/image-2.png)
...
![Dashboard Top Section](benchmark_results/single-node-redis/single_key_20260127_214303/report/grafana_dashboard_top_1769525455862.png)
...
![Dashboard Middle Section](benchmark_results/single-node-redis/single_key_20260127_214303/report/grafana_dashboard_middle_1769525500675.png)
*Figure 4.2: Redis latency spike tại saturation point confirms Redis là bottleneck.*

**Redis Resources & Envoy Load Balancer**
![Dashboard Bottom Section](benchmark_results/single-node-redis/single_key_20260127_214303/report/grafana_dashboard_envoy_and_stats_1769525560378.png)
...
![100 Keys Top](benchmark_results/single-node-redis/hundred_keys_20260128_071830/report/grafana_100keys_top_1769944529346.png)
*Figure 4.4: Throughput stable đến 20k RPS, sau đó cliff drop.*

**JVM & Redis Performance**
![100 Keys Middle](benchmark_results/single-node-redis/hundred_keys_20260128_071830/report/grafana_100keys_middle_1769944574745.png)
*Figure 4.5: Redis latency tăng exponential sau 20k RPS.*

**Envoy & Network Stats**
![100 Keys Bottom](benchmark_results/single-node-redis/hundred_keys_20260128_071830/report/grafana_100keys_bottom_1769944831436.png)
...
![Hot Key Top](benchmark_results/single-node-redis/hundred_keys_hot_20260201_184238/report/grafana_hotkey_top_1769948240483.png)
*Figure 4.7: Sharp drop in throughput và massive spike in latency tại 20k RPS step.*

**Resource Utilization**
![Hot Key Middle](benchmark_results/single-node-redis/hundred_keys_hot_20260201_184238/report/grafana_hotkey_middle_1769948331576.png)
*Figure 4.8: JVM Memory và CPU plateau khi application trở thành I/O bound.*

**Redis Performance**
![Hot Key Bottom](benchmark_results/single-node-redis/hundred_keys_hot_20260201_184238/report/grafana_hotkey_bottom_1769948343755.png)
...
![Dragonfly Hot Key](benchmark_results/single-node-dragonfly/hundred_keys_hot_20260204_184238/screenshot_01-10-09%205_2_2026.png)
...
![alt text](benchmark_results/image-11.png)
...
![alt text](benchmark_results/image-3.png)
...
![alt text](benchmark_results/image-4.png)
...
![alt text](benchmark_results/image-5.png)
...
![alt text](benchmark_results/image-6.png)
...
![alt text](benchmark_results/image-7.png)
...
![alt text](benchmark_results/image-8.png)
...
![alt text](benchmark_results/image-9.png)
...
![alt text](benchmark_results/image-10.png)
...
| Artifact | Location |
|----------|----------|
| Redis Single Key Report | `benchmark_results/single-node-redis/single_key_20260127_214303/` |
| Redis 100 Keys Uniform Report | `benchmark_results/single-node-redis/hundred_keys_20260128_071830/` |
| Redis 100 Keys Hot Report | `benchmark_results/single-node-redis/hundred_keys_hot_20260201_184238/` |
| Dragonfly 100 Keys Uniform Report | `benchmark_results/single-node-dragonfly/hundred_keys_20260204_12345/` |
| Dragonfly 100 Keys Hot Report | `benchmark_results/single-node-dragonfly/hundred_keys_hot_20260204_184238/` |
